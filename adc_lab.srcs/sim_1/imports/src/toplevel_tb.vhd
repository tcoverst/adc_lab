...
begin
    ...
    -- Set up rotating PSEN signals
-- Set up rotating PSEN signals
    --for i in 0 to 222 loop
        --wait for 1 ns;  -- Time delay for each step
        PSEN <= '1';  -- Set PSEN high to rotate ADC_CLK
        -- 8000ps / 17.9ps = 447 
        -- 447 * 65ns = 29055ns
        wait for 115 * 65 ns;  -- Keep PSEN high for a full clock cycle
        PSEN <= '0';  -- Reset PSEN to rotate ADC_CLK further
    --end loop;
